<%-- 
    Document   : AReport
    Created on : 12 Apr, 2018, 2:03:33 AM
    Author     : dnyaneshwar
--%>
...
<div class="mainHeaderTop"> 
    ...
    <div class="logoWrapper"> 
            ...
            <a href="index.jsp"><img src="images/alogo.jpg"  class="img-responsive" width="186" height="55"></a>
...
<ul>	                         
                    <li class=""> <a href="index.jsp" >Home</a></li>
                     <li class="">  <a href="p_rp.jsp">Back</a></li>
                  <li class="">  <a href="pcd.jsp">Ads Detail Report</a></li>                   
 ...
 if(resultset.next()){
	  userID = resultset.getString("pid");
           ...
           // resultset =  statement.executeQuery("select m_name,Ad_request,Bilable_impression,count,fill_rate from m_content,p_content where m_content.a_name=p_content.m_name and pid='"+userID+"'");
            resultset = statement.executeQuery("select mid,p_name,a_name,date,domain,a_file,a_size,total_time,pay,cmp,total_pay,status,status1 from m_content,payment,new_provider n   where  m_content.mid=payment.mpid and m_content.pid=n.pid  ");
  ...
  <form  >
    ...
    <center>
             <div id="ptr">   
                 <h5>Provider Avertisement Report </h5>
       <table id="customers">
                                    <colgroup>
                                      <col span="12" >
					...
					<thead>
						<tr>
                                                        ...
                                                        <th>Total Time</th>
                                                        <th>Payment(Rs)</th>                                                        
                                                        <th>Ads Advance(Rs)</th>
                                                        <th>Total Payment(Rs) </th>                                                       
                                                        <th>Ads Published Status </th>
                ...
                <center>
                    <button type="submit" class="custom-btn btn-anim" onclick="myFunction('ptr')" > <span>Print</span></button>  </center>                                        

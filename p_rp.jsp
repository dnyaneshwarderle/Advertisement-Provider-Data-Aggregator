...
<%-- 
    Document   : p_rp
    Created on : 26 Feb, 2018, 8:14:31 PM
    Author     : dnyaneshwar
--%>
...
<ul>
                  <li class=""> <a href="index.jsp" >Home</a></li>
                     <li class="">   <a href="pcd.jsp">Ads Details Report</a></li>
                      <li class=""> <a href="AReport.jsp">Provider Data Report</a></li>
...
<section class="sectionWrapper">
 ...
 <% 
       ...
       userID = resultset.getString("pid");
         ...
         resultset = statement.executeQuery("select mid,p_name,a_name,date,domain,a_file,a_size,s_time1,time_sec1,s_time2,time_sec2,s_time3,time_sec3,cmp,status from m_content,new_provider where m_content.pid=new_provider.pid ORDER BY mid DESC");
        %>
 <br>
 ...
 <center>
  <form   action="Advertise.jsp" method="post">
			<table id="customers">
                                    <colgroup>
    <col  span="14" >
  			...
  			<thead>
						<tr>
                                                ...
                                                <% while(resultset.next()){ %>
                                                 <tbody>
						<tr>
                                                    <td><button type="submit" name="chk1" class="button"  value="<%= resultset.getString(1) %>" >Publish</button></td>
...
<!--<script src="https://nerolac.com/assets/js/main.js"></script>-->

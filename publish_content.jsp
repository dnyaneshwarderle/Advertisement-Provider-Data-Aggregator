...
})(window,document,'script','dataLayer','GTM-K3L76JK');
</script>
...
<ul>
                    ...
                    <li class="">  <a href="Provider_data.jsp">Back </a></li>
                    <li class=""> <a href="Provider_data.jsp">Import Data </a></li>
                    <li class="">  <a href="pReport.jsp">Check Report</a></li>
                    <li class=""><a href="contactUs.jsp"  >Contact Us</a></li>	
                  
                <!--Primary Sub-Navigation Ends-->
                <div class="clearfix"></div>
...
<% 
       ...
       String userID = "";
        ...
        resultset = statement.executeQuery("select mid,a_name,date,domain,a_file,a_size,s_time1,time_sec1,s_time2,time_sec2,s_time3,time_sec3,cmp,status1 from m_content  where  pid='"+userID +"' ORDER BY mid DESC ");
    %>
 <br>
  ...
  <form   action="payment.jsp" method="post">
    ...
    <center>
       ...
       <section class="sectionWrapper essentialToolsWrapper">
           <h5><font color="red"><blink> Please Select Your Payment Mode Here</blink></font></h5>
  			...
  			<thead>
						<tr>
							...
							<th> Advertise name</th>
                                                        <th>Date&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                                                          <th>Domain </th>
                                                           <th>Ads File</th>
                                                         <th>Ads size</th>
                                                          <th>Start Time1</th>
						...
						<tr>
                                                    ...
                                                    <td><button type="submit" class="button" name="chk" value="<%= resultset.getString(1) %>" onclick="Validate()">Payment</button></td>
                                                         ...
                                                         <td> <%= resultset.getString(13) %></td>
                                                          ...
                                                          <form action="modify.jsp" method="post">
                                                              <td><button type="submit" name="sub" class="button"  value="<%= resultset.getString(1) %>" >modify</button></td>
                                                          </form>
                                                                <form action="delete.jsp" method="post">
                                                                    <td><button type="submit" name="btn" class="button" value="<%= resultset.getString(1) %>" >Delete</button></td>  </form>
                                                     </tr><%}%>   

<%-- 
    Document   : AfPass
    Created on : 17 Apr, 2018, 12:43:14 PM
    Author     : dnyaneshwar
--%>
                ...
                <div class="row">                    
                  ...
                  <div class="col-md-4">
                        <div class="formContainer">
                            ...
                            <form   class="form-horizontal" method="post" action="Aforgotpass.jsp"  >
...
<div class="form-group">
                                <label  class="col-sm-4 control-label">Username<span class="star">*</span></label>
                                <div class="col-sm-8">
                                    <input id="username" name="unm" type="text" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-4 control-label">Forgot Password<span class="star">*</span></label>
                                <div class="col-sm-8">
                                    <input id="login-password"  name="pswd" type="password" class="form-control" required/>
                                </div>
                            </div>                                        
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-4">
                                  <button type="submit" class="custom-btn btn-anim btn-block" ><span>Forgot</span></button>
                                </div>
                           </div></form>
 ...
 <section class="sectionWrapper essentialToolsWrapper">
                ...
                <h5>Provider please Forgot your Password </h5>
                <div class="container">
                    <div class="row">
...
<ul class="list-unstyled footer-menu"><li> <a href=""  >ABOUT US</a></li><li> <a href=""  >CAREERS</a></li><li> <a href="https://nerolac.com/contact-us.html"  >GET IN TOUCH</a></li>
</ul>

                                </div>
                                <div class="col-sm-6">
                                     
<ul class="list-unstyled footer-menu"><li> <a href=""  >GREEN TIPS</a></li><li> <a href=""  >OUR FINANCIALS</a></li><li> <a href="https://nerolac.com/financial/press-releases.html" title="Media" >MEDIA</a></li>
</ul>
                                </div>
                            </div>
                        </div>

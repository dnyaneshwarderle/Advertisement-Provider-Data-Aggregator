...
<div class="mainHeaderTop"> 
    ...
    <div class="logoWrapper"> 
            ...
            <a href="index.jsp"><img src="images/alogo.jpg"   ></a>
...
<ul class="menuList">
    ...
    <div class="clearfix"></div>
        ...
        <div class="mainHeaderBottom"> 
            <!--Corporate Dropdown starts-->
            

            <!--Corporate Dropdown Ends-->
            <div class="overflowMenuWrapper">
                <!--Primary Navigation for small devices-->
                <ul class="primarySmall" id="primarySmallMenu">

</li>
</ul>
                <!--Primary Sub-Navigation Starts-->
...
<input type="hidden" name="zoo_visitor_error_delimiters" value=""><input type="hidden" name="AG" value="B4UuBMveuATKIE+whI14SoE0m71bINpXlf4J+HVA43E="><input type="hidden" name="autologin" value=""><input type="hidden" name="zoo_visitor_action" id="zoo_visitor_action" value="register"> 
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Ads name:<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                            <input id="email" name="ad" type="text" class="form-control" required/>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Advertise File:<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                            <input id="member_mobile" name="adf" type="text" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Advertise Size:<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Advance Pay:<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="cmp" type="text" class="form-control" required/>
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Start Time1:<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="st1" type="text" class="form-control" required/>
                                        </div>
                                    </div> 
                                </div>
                         ...
                         <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Time1(sec):<span class="star">*</span></label>
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="t1" type="text" class="form-control" required/>
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Start Time2:</label>
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="st2" type="text" class="form-control"/>
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Time2(sec):</label>
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="t2" type="text" class="form-control" />
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Start Time3:</label>
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="st3" type="text" class="form-control" />
                                        </div>
                                    </div> 
                                </div>
                             ...
                             <div class="col-sm-6">
                                    <div class="form-group">
                                        <label  class="col-sm-4 control-label">Time3(sec):</label>
                                        <div class="col-sm-8">
                                            <input id="password_confirm" name="t3" type="text" class="form-control" />
                                        </div>
                                    </div> 
                                </div>
                            </div>
...
<button type="submit" class="custom-btn btn-anim"><span>Submit</span></button>&nbsp
<button type="reset" class="custom-btn btn-anim"><span>Clear</span></button>
                            </form>
...
<script type="text/javascript" charset="utf-8" src="https://nerolac.com/?ACT=6&ui=core,widget,mouse,position,draggable,resizable,button,dialog,datepicker&plugin=markitup,toolbox.expose,overlay,tmpl&ffile=underscore,cp/date&v=1512717956&include_jquery=y"></script>
...
$(document).ready(function()
{
	...
	$.datepicker.setDefaults({dateFormat:"m/d/yy"+EE.date_obj_time});
						...
						$('input[name="member_birthday"]').datepicker({
							...
							defaultDate: new Date(1523780938000)
						});
					
	$.datepicker.setDefaults({defaultDate: new Date(1523780938000)});
});
// ]]>
</script>
<style type="text/css">.hasDatepicker{background:#fff url(https://nerolac.com/themes/cp_themes/default/images/calendar_bg.gif) no-repeat 98% 2px;background-repeat:no-repeat;background-position:99%;}</style>               
                        </div>
                    </div>
                </div>
            </section>
...
<ul class="list-unstyled footer-menu"><li> <a href=""  >GREEN TIPS</a></li><li> <a href=""  >OUR FINANCIALS</a></li><li> <a href="" title="Media" >MEDIA</a></li>
                        ...
                        <div class="col-sm-6">
                         <form action="https://nerolac.com/?ACT=23" accept-charset="utf-8" id="subscribe" class="form-inline text-right" method="post"><div style="display:none">

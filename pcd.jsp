<%-- 
    Document   : pcd
    Created on : 26 Feb, 2018, 8:35:31 PM
    Author     : dnyaneshwar
--%>
...
<%
         ...
         //   ResultSet resultset;   
             ResultSet resultset = statement.executeQuery("select pid from new_provider where p_name='"+anm+"'");
             String pid="";
             if(resultset.next())
             {
                   pid = resultset.getString("pid");
             }    
            resultset = statement.executeQuery("select m_name,p_name,Ad_request,Bilable_impression,count,fill_rate from p_content,new_provider n where n.pid=p_content.npid     ");
%>
 <br>
	...
	<center>		
       <form  >
            <div id="ptr">
                <h5>Ads Requested & Details Report</h5>

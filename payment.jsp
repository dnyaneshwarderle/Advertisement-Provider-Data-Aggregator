<%-- 
    Document   : payment
    Created on : 26 Feb, 2018, 7:24:30 PM
    Author     : dnyaneshwar
--%>
    ...
    <div class="menuWrapper"> 
        ...
        <ul class="socialLinks">
         <li><a href="https://www.facebook.com/" target="_blank" class="icon-facebook"></a></li>                            
                                ...
                                <li><a href="https://www.youtube.com/" target="_blank" class="icon-youtube"></a></li> <div class="clearfix"></div>
        </ul> 
        <ul class="menuList">
...
<ul>
                     ...
                     <li class="">  <a href="publish_content.jsp">Back </a></li>
                                                  ...
                                                  <tr>
                                                   ...
                                                   <tr>
                                                    ...
                                                    <% } %>
                                                     ...
                                                     <button type="submit" class="custom-btn btn-anim"><span>Bill</span></button>
   </center>
			</form>

<%-- 
    Document   : AllProvider
    Created on : 18 Apr, 2018, 8:16:08 PM
    Author     : dnyaneshwar
--%>
...
%>
 <br>
	...
	<center>		
       <form method="post" action="pcd.jsp" >
					...
					<thead>
						...
						<tr>
							...
							<td> <%= resultset.getString(1) %></td>
                                                        <td> <input type="submit" name="anm" class="button" value="<%= resultset.getString(2) %>"></td>

            ...
            <div class="slides">
                <div class="slide">
                    <div class="contentHolder">
                        <div class="contentHolderIns" style="background-image:url(images/services.jpg)"><img src="images/services.jpg" class="hide" />
                            <div class="container">
                                <div class="captionWrapper brown"> 
                                    <h3 class="text-center"><span data-animate="fadeInUp"><font color="Orange">Login</font></span></h3>                                
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">                    
                  ...
                  <div class="col-md-4">
                        <div class="formContainer">
                            <h5>Login</h5>
                            <form  id="loginForm" class="form-horizontal" method="post" action="Aloginsuccess.jsp"  >
<div class='hiddenFields'>
<input type="hidden" name="visitor_action" value="login" />
<input type="hidden" name="RET" value="profile.html" />
<input type="hidden" name="site_id" value="1" />
<input type="hidden" name="csrf_token" value="a14d122f109ba4239efef4ae79025c45b23d2700" />
</div>

<div class="form-group">
                                <label  class="col-sm-4 control-label">Email<span class="star">*</span></label>
                                <div class="col-sm-8">
                                    <input id="username" name="unm" type="text" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="name" class="col-sm-4 control-label">Password<span class="star">*</span></label>
                                <div class="col-sm-8">
                                    <input id="login-password"  name="passw" type="password" class="form-control" required/>
                                </div>
                            </div>                                        
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-4">
                                  <button type="submit" class="custom-btn btn-anim btn-block" ><span>Login</span></button>
                                </div>
                           </div></form>
                                                         <div class="forgot-assword-link"><a href="AfPass.jsp">Forgot Password?</a></div>                              
                        </div>
                    </div>
                   
 <section class="sectionWrapper essentialToolsWrapper">
                <h3>Open Ads Network</h3>
                <h5>Administrator please Login first </h5>
                <div class="container">
                    <div class="row">
                        <ul class="essentialToolsViewport">                        
...
<ul class="list-inline"><li> <a 
            ...
            href="index.jsp"
              >Home</a></li><li> <a href="" >Privacy Policy</a></li><li> <a href="" >Terms & Conditions</a></li><li> <a href="https://nerolac.com/quality-policy.html" >Quality Policy</a></li><li> <a href="https://nerolac.com/sitemap.html" >Site Map</a></li>
</ul>
